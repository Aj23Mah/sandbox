...
const Hero = () => {
  return (
    <div className="lg:px-32 py-5 h-auto w-full"> 
      <div className="bg-primary rounded-xl flex flex-wrap justify-between items-center mx-auto mt-10 md:px-12 px-4 md:justify-center md:flex-row sm:justify-center">
        <div className="text-black mb-14 lg:w-1/2">
          ...
          <div className="max-w-xl text-center lg:text-left lg:max-w-md md:text-2xl text-md mb-8 text-black-light">
        ...
        <div className="lg:w-1/2">
          <img className="ml-auto" src={co3} height='100%' width='74%' alt="" />
        </div>
      </div>
    </div>
  );
